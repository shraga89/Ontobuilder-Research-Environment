...
/**
 * Wrapper for default configurated Tree Edit Distance based Graph Match
 * @author Tomer Sagi
 *
 */
public class OBTEDGraphMatch implements FirstLineMatcher { 
	/* (non-Javadoc)
	 * @see ac.technion.schemamatching.matchers.FirstLineMatcher#getName()
	 */
	public String getName() {
		return "Ontobuilder TED Graph Match";
	}
	...
	public String getConfig() { 
		...
		return config;
		//TODO - allow setting of parameters
	}
